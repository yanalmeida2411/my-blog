...
import { FiMenu, FiX, FiLogOut, FiHome, FiUsers, FiUserCheck, FiFileText ,FiUser } from 'react-icons/fi'
...
export default function BlogLayout({ children }: { children: React.ReactNode }) {
  ...
  const links = [
    ...
    { name: 'Meu Pefil', href: `/blog/${userId.toString()}/meuperfil`, icon: <FiUser size={20} /> },
